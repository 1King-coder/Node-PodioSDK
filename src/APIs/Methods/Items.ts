import { IPodioItems } from "../../interfaces/podio_interfaces";
import { AddItemPayload, AddItemResponse, ExportOptions, ExportResponse, FilterOptions,
   FindReferenceableItemsResponse, PodioAppItem, ItemRevision, PodioItemRevisionDif,
    ...
    FilterItemsResponse} from "../../types/podio_types";
import { Podio } from "../podioAPI";

export class PodioItems extends Podio implements IPodioItems {

  constructor(podio: Podio) {
    super(podio.creds, podio.token_path);
  }
